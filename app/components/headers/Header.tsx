...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 right-0 left-0 py-5 z-[2]">
      <Container>
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            >
              <span className="w-full h-full relative cursor-pointer">
                <span className="w-full h-[1px] bg-[rgb(var(--menu-color))] block absolute top-0"></span>
                <span className="w-full h-[1px] bg-[rgb(var(--menu-color))] block absolute top-[50%]"></span>
                <span className="w-full h-[1px] bg-[rgb(var(--menu-color))] block absolute bottom-0"></span>
              </span>
            </Button>
          </div>
        </div>
